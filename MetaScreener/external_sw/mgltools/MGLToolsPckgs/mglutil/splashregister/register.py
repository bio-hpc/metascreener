...
# $Author: autin $
# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/register.py,v 1.27 2014/08/28 22:20:09 autin Exp $
# $Date: 2014/08/28 22:20:09 $
# $Id: register.py,v 1.27 2014/08/28 22:20:09 autin Exp $

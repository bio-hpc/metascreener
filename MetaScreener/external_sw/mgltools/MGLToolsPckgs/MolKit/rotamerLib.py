...
#
# $Header: /opt/cvs/python/packages/share1.5/MolKit/rotamerLib.py,v 1.2 2014/08/21 23:39:02 sanner Exp $
#
# $Id: rotamerLib.py,v 1.2 2014/08/21 23:39:02 sanner Exp $
#
import MolKit, os

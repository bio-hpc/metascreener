...
void main()  {\n
    ...
    if (radius < 1.0)\n
      ...
      if (doshadow == 1){
        //model transform
        vWorldPosition = lightRot *spaceposition;
        normal = normalize(gl_NormalMatrix * gl_Normal);
        //model-view transform
        coord =  gl_ModelViewMatrix * spaceposition;//is this working ?gl_TextureMatrix[7]
        //gl_FrontColor = gl_Color;
        //light transform PVM
        shadowDir = lightProj * lightView *  lightRot * spaceposition;// * gl_ModelViewMatrix - vec4(LightSourcePos, 1.0);    
        }
     }
"""

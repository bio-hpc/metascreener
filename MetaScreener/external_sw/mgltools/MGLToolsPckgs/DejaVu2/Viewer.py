...
#########################################################################
#
# $Header: /opt/cvs/DejaVu2/Viewer.py,v 1.2 2014/07/16 21:49:11 sanner Exp $
#
# $Id: Viewer.py,v 1.2 2014/07/16 21:49:11 sanner Exp $
#
...
see also: FindObjectByName"""
    ...
    def __init__(self, master=None, nogui=0, screenName=None,
                 ...
                 autoRedraw=True, verbose=True, eventHandler=None,
                 cnf={}, **kw):
...
"""
	...
	c = self.AddCamera(master=master, screenName=screenName,
                           classCamera=classCamera, stereo='none', num=0,
                           cnf=cnf, **kw)
...
"""
        #print "ToggleDepth"
        self.depthcued = not self.depthcued
        self.currentCamera.fog.Set(enabled=self.depthcued)
        self.Redraw()
            ...
            if self.tileRender:
                ...
                for i in range(numOfPasses):
                    ...
                    tr.oneTileRenderBuffer = Numeric.zeros(
                        c._width * c._height * 3, Numeric.UnsignedInt8)

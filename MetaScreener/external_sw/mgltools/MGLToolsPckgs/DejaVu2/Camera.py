...
#########################################################################
#
# $Header: /opt/cvs/DejaVu2/Camera.py,v 1.5 2014/07/12 21:04:26 autin Exp $
#
# $Id: Camera.py,v 1.5 2014/07/12 21:04:26 autin Exp $
#
...
size camera._width*camera._height*3"""
    ...
    def GrabZBuffer(self, lock=True, flipTopBottom=True, zmin=None, zmax=None):
        ...
        if (zmax!=zmin):
            ...
            zval1 = Numeric.ones(self._width*self._height, 'f')*zmax*255
...
#        glActiveTexture(GL_TEXTURE0);
    ...
    def RedrawAASwitch(self, *dummy):
        ...
        if self.swap:
            self.SwapBuffers()
            #on windows this extra swap buffer make the screen flahsing
            #self.SwapBuffers()

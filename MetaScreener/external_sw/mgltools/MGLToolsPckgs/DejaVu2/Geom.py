...
#
# $Header: /opt/cvs/DejaVu2/Geom.py,v 1.2 2014/07/16 21:29:44 sanner Exp $
#
# $Id: Geom.py,v 1.2 2014/07/16 21:29:44 sanner Exp $
#
...
"""
    ...
    def deleteOpenglList(self):
        ...
        if self.outline.dpyList is not None:
            currentcontext = self.viewer.currentCamera.tgetContext()

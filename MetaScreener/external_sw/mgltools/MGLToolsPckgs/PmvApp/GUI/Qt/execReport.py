...
#
# $Header: /opt/cvs/PmvApp/GUI/Qt/execReport.py,v 1.7 2014/07/12 01:15:26 sanner Exp $
#
# $Id: execReport.py,v 1.7 2014/07/12 01:15:26 sanner Exp $
#
import sys, os
...
class TimmingTab(QtGui.QWidget):
    def __init__(self, report, parent=None):
        super(TimmingTab, self).__init__(parent)
        t0 = report.startTime
        topLabel = QtGui.QLabel("Timming:")
...
class ExecutionReport(QtGui.QWidget):
    ...
    def __init__(self, report, title, parent=None):
        ...
        tabWidget.addTab(TimmingTab(report), 'Timmimg')

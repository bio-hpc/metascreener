...
#
# $Header: /opt/cvs/PmvApp/bondsCmds.py,v 1.5 2014/07/11 05:59:37 sanner Exp $
#
# $Id: bondsCmds.py,v 1.5 2014/07/11 05:59:37 sanner Exp $
#
#
import numpy
        ...
        for mol, atm in map(None, molecules, atomSets):
            if self.hasBhtree:
                ...
                for chain in mol.chains:
                    atmInChain = AtomSet([x for x in atm if x.parent.parent.id == chain.id])

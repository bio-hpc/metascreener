...
#############################################################################
#
# $Header: /opt/cvs/PmvApp/secondaryStructureCmds.py,v 1.6 2014/07/24 23:36:59 annao Exp $
#
# $Id: secondaryStructureCmds.py,v 1.6 2014/07/24 23:36:59 annao Exp $
#
                        ...
                        if not shape2 is None:
                            if SS.__class__.__name__ in ['Strand', 'Helix']:
                                ...
                                if rt=='NA':
                                    ...
                                    if hasattr(NAp, "loadCommand"):
                                        NAp = self.app().Nucleic_Acids_properties.loadCommand()

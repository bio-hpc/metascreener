...
# $Header: /opt/cvs/PmvApp/extrusionCmds.py,v 1.2 2014/07/11 05:26:11 sanner Exp $
#
# $Id: extrusionCmds.py,v 1.2 2014/07/11 05:26:11 sanner Exp $
#
...
class ComputeSheet2DCommand(MVCommand):
    ...
    Required Arguments:\n   
        nodes --- MolKit set of nodes describing molecular components \n

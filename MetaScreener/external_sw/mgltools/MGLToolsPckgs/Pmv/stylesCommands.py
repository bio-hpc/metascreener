...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/stylesCommands.py,v 1.13 2011/09/30 23:36:21 annao Exp $
# 
# $Id: stylesCommands.py,v 1.13 2011/09/30 23:36:21 annao Exp $
#
...
##         self.vf.undo.addEntry((undoCmd), (name))
    ...
    def undo(self, args, **kw):
        ...
        stack = self.undoRenderingStack
        if len(stack): setRendering(self.vf.GUI.VIEWER, stack.pop(), True)

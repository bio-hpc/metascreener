...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/deleteCommands.py,v 1.85 2013/10/15 18:00:17 annao Exp $
#
# $Id: deleteCommands.py,v 1.85 2013/10/15 18:00:17 annao Exp $
#
...
class DeleteAtomSet(MVCommand):
    ...
    def __call__(self, atoms, **kw):
        ...
        if not len(ats):
            return 'ERROR'
        # MS here we create a copy of hat findType returns

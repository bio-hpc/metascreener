#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/viewsCommands.py,v 1.5 2011/03/02 01:22:27 annao Exp $
# 
# $Id: viewsCommands.py,v 1.5 2011/03/02 01:22:27 annao Exp $
#
...
class ViewsCommand(MVCommand):
    ...
    def addViewButton(self, name, icon = True):
        ...
        if icon == True:
            ...
            photo, ims = self.vf.GUI.VIEWER.GUI.getButtonIcon()
    ...
    def activateView(self, name, button = None):
        ...
        if button: 
            if not hasattr(button, "photo"):
                ...
                vi.OneRedraw()
                photo, ims = vi.GUI.getButtonIcon()

...
ingr1h6i = SingleSphereIngr( MSca*.001, color=aquamarine, pdb='1h6i',
                             name='AUQAPORINE',
                             sphereFile='recipes/membrane/1h6i.sph',
                             meshFile='recipes/membrane/1h6i',
                             packingPriority=10,
                             jitterMax=(1,1,0.2),
...
ingr1zll = SingleSphereIngr( MSca*.001, color=darkorchid, pdb='1zll',
                             name='PHOSPHOLAMBAN',
                             sphereFile='recipes/membrane/1zll.sph',
                             meshFile='recipes/membrane/1zll',
                             packingPriority=5,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr2afl = SingleSphereIngr( MSca*.001, color=lightcoral, pdb='2afl',
                             ...
                             sphereFile='recipes/membrane/2afl.sph',
                             meshFile='recipes/membrane/2afl',
                             packingPriority=10,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr2uuh = MultiSphereIngr( MSca*.001, color=gold, name='C4 SYNTHASE',
                            sphereFile='recipes/membrane/2uuh.sph',
                            meshFile='recipes/membrane/2uuh', pdb='2uuh',
                            packingPriority=5,
                            jitterMax=(1,1,.2),
                            principalVector=(0,0,-1))
...
ingr1yg1 = MultiSphereIngr( MSca*.001, color=khaki, pdb='1yg1',
                             ...
                             sphereFile='recipes/membrane/1yg1.sph',
                             meshFile='recipes/membrane/1yg1',
                             packingPriority=5,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr1ojc = MultiSphereIngr( MSca*.001, color=blueviolet, pdb='1ojc',
                             name='OXIDOREDUCTASE',
                             sphereFile='recipes/membrane/1ojc.sph',
                             meshFile='recipes/membrane/1ojc',
                             packingPriority=10,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr1qo1 = MultiSphereIngr( MSca*.0005, color=limegreen, pdb='1qo1',
                             name='ATP SYNTHASE',
                             sphereFile='recipes/membrane/1qo1.sph',
                             meshFile='recipes/membrane/1qo1',
                             packingPriority=1,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr2abm = MultiSphereIngr( MSca*.001, color=darkcyan, pdb='2abm',
                             ...
                             sphereFile='recipes/membrane/2abm.sph',
                             meshFile='recipes/membrane/2abm',
                             packingPriority=2,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr3g61 = MultiSphereIngr( MSca*.001, color=darkcyan, pdb='3g61',
                             name='P-GLYCOPROTEIN',
                             sphereFile='recipes/membrane/3g61.sph',
                             meshFile='recipes/membrane/3g61',
                             packingPriority=2,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,1))
...
ingr2bg9 = MultiSphereIngr( MSca*.001, color=deeppink, pdb='2bg9',
                             ...
                             sphereFile='recipes/membrane/2bg9.sph',
                             meshFile='recipes/membrane/2bg9',
                             packingPriority=2,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,-1))
...
ingr2a79 = MultiSphereIngr( MSca*.001, color=gold, pdb='2a79',
                             ...
                             sphereFile='recipes/membrane/2a79.sph',
                             meshFile='recipes/membrane/2a79',
                             packingPriority=1,
                             jitterMax=(1,1,0.2),
                             principalVector=(0,0,1))
...
kinase1 = SingleSphereIngr( MSca*.08,  16., color=brown, name='kinase1',
                            meshFile='recipes/cyto/1ABL_centered', pdb='1ABL')
...
GroelIngr1 = MultiSphereIngr( MSca*.00004, name='Groel', pdb='1AON',
                              sphereFile='recipes/cyto/1AON_centered.sph',
                              meshFile='recipes/cyto/1AON_centered',
...
ingr2CPK = MultiSphereIngr( MSca*.0004, name='PHOSPHOTRANSFERASE', pdb='2CPK',
                            sphereFile='recipes/cyto/2CPK_centered.sph',
                            meshFile='recipes/cyto/2CPK_centered',
...
ingr1CZA = MultiSphereIngr( MSca*.0004, name='TRANSFERASE', pdb='1CZA',
                            sphereFile='recipes/cyto/1CZA_centered.sph',
                            meshFile='recipes/cyto/1CZA_centered',
...
ingr2OT8 = MultiSphereIngr( MSca*.0001, name='TRANSPORT PROTEIN', pdb='2OT8',
                            sphereFile='recipes/cyto/2OT8_centered.sph',
                            meshFile='recipes/cyto/2OT8_centered',
                            color=tomato, packingPriority=1)
rCyto.addIngredient( ingr2OT8 )

# 1TWT
ingr1TWT = MultiSphereIngr( MSca*.00005, name='30S RIBOSOME', pdb='1TWT',
                            sphereFile='recipes/cyto/1TWT_centered.sph',
                            meshFile='recipes/cyto/1TWT_centered',

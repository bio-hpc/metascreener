...
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/autotorsCommands.py,v 1.130 2014/11/04 17:06:11 rhuey Exp $
#
# $Id: autotorsCommands.py,v 1.130 2014/11/04 17:06:11 rhuey Exp $
#
#
#
#
...
"""
    ...
    def onAddCmdToViewer(self):
        if not hasattr(self.vf, 'atorsDict'):
            self.vf.atorsDict={}
        if 'write CONECT records' not in self.vf.userpref.settings.keys():
    ...
    def doit(self, filename):
        ...
        if mol.LPO.version>=4:
            ...
            return "ERROR"
        value = False
        if "write CONECT records" in self.vf.userpref.keys(): 
